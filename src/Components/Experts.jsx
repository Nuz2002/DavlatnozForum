...
const ExpertCard = ({ expert }) => {
  return (
    <div className="max-w-sm bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg p-6 flex flex-col h-full">
        ...
        <div className="text-center">
          <div className="relative inline-block">
            <img
              ...
              alt={expert.name}
            />
            <span className="absolute bottom-0 right-0 transform translate-x-1/4 -translate-y-1/4 bg-blue-500 rounded-full p-1 flex items-center justify-center">
              <svg
          ...
          <p className="text-gray-600 dark:text-gray-400">@{expert.username}</p>
        </div>
        <p className="mt-3 text-center text-sm text-gray-700 dark:text-gray-300 h-20 line-clamp-4">
          {expert.bio}
        </p>
